...
public class CustomerController {
    ...
    //             Функционал контроллера покупателей
...
//    Вернуть стоимость корзины покупателя по его идентификатору (если он активен).
    ...
    public double getCustomersDishesTotalCost(Long id) {
        return service.getCustomerDishesTotalCost(id);
    }
...
//    Вернуть среднюю стоимость продукта в корзине покупателя по его идентификатору (если он активен)
    ...
    public double getCustomersDishesAveragePrice(Long id) {
        return service.getCustomersDishesAveragePrice(id);
    }

//    Добавить товар в корзину покупателя по их идентификаторам (если оба активны)

    public void addDishToCustomerDishes(Long customerId, Long dishId) {
        service.addDishToCustomersDishes(customerId, dishId);
    }

//    Удалить товар из корзины покупателя по их идентификаторам

    public void removeDishFromCustomersDishes(Long customerId, Long dishId) {
        service.removeDishFromCustomersDishes(customerId, dishId);
    }

//    Полностью очистить корзину покупателя по его идентификатору (если он активен)

    public void clearCustomersDishes(Long customerId) {
        service.clearCustomersDishes(customerId);
    }
}
